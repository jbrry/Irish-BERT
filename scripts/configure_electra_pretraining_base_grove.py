...
class PretrainingConfig(object):
  ...
  def __init__(self, model_name, data_dir, **kwargs):
    ...
    self.vocab_size = 30101  # number of tokens in the vocabulary
    ...
    # paper for the full hyperparameters
      ...
      self.max_seq_length = 128 # fix it to 128 for experiments
      self.learning_rate = 2e-4
      if self.model_size == "base":
        self.embedding_size = 768
        self.generator_hidden_size = 0.33333
        self.train_batch_size = 32 # smaller batch size for GPU experiments
      else:
