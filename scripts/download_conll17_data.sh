...
# download handle for UD2017 data for Irish
...
DATASET_DIR="data/ga/UD2017-data"
mkdir -p $DATASET_DIR

echo "Downloading data from UD 2017..."$'\n'
...
echo "Downloading UDPipe model for ga..."$'\n'
...
for xzf in ${data}; do
	...
	# TODO: this file needs to be downloaded and put in a shared location
        perl ~/ud_folder/conllu_to_text.pl --language=ga_idt < ${conllu_file}  > ${DATASET_DIR}/${filestring}.txt
